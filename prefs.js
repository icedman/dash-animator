...
const Gettext = imports.gettext.domain('dash-animator');
const _ = Gettext.gettext;

const ExtensionUtils = imports.misc.extensionUtils;

var schema_id = 'org.gnome.shell.extensions.dash-animator';
...
const DashAnimatorSettingListBoxRow = GObject.registerClass(
  {
    Properties: {
  ...
  class DashAnimatorSettingListBoxRow extends Gtk.ListBoxRow {
...
const DashAnimatorSettingsPane = GObject.registerClass(
  class DashAnimatorSettingsPane extends Gtk.Frame {
    _init() {
      super._init({
        margin_top: 36,
        margin_bottom: 36,
      ...
      const reuseDash = new DashAnimatorSettingListBoxRow(
      ...
      const shrinkIcons = new DashAnimatorSettingListBoxRow(
        _('Shrink icons'),
        _('Shrink dash icons'),
      ...
      const animateIcons = new DashAnimatorSettingListBoxRow(
        _('Animate Icons'),
      ...
      const autohideDash = new DashAnimatorSettingListBoxRow(
        _('Autohide'),
      ...
      const backgroundDark = new DashAnimatorSettingListBoxRow(
        _('Dark background'),
      ...
      const backgroundOpacity = new DashAnimatorSettingListBoxRow(
...
const DashAnimatorSettingsWidget = GObject.registerClass(
  class DashAnimatorSettingsWidget extends Gtk.Notebook {
    _init() {
      super._init();

      const _settingsPane = new DashAnimatorSettingsPane();
...
function buildPrefsWidget() {
  return new DashAnimatorSettingsWidget();
}
