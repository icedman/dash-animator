...
const GETTEXT_DOMAIN = 'dash-animator';
    ...
    const actions = [
      {
        ...
        link: 'https://github.com/icedman/dash-animator/issues',
      },
      {
        name: 'open-readme',
        link: 'https://github.com/icedman/dash-animator',
      },
      {
        name: 'open-license',
        link: 'https://github.com/icedman/dash-animator/blob/master/LICENSE',
      },
    ];
